// Onboarding — brugerens FØRSTE møde med ReciDeal. Rækkefølgen følger en
...
// Inspireret af de store mad-apps (ReciMe m.fl.), men i ReciDeals varme stil og
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.logoRow}>
            ...
            <Text style={styles.logo}>ReciDeal<Text style={{ color: Colors.red }}>.</Text></Text>
          </View>
        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          {aktuel === 'bekraeft' && (
            <View style={styles.midtStil}>
              ...
              <Text style={styles.broedtekst}>
                Det er præcis det ReciDeal er bygget til. Vi hjælper dig hele vejen — fra opskrift til indkøbskurv.
              </Text>
          ...
          {/* Import-guide — telefon-mockup der peger på ReciDeals +-ark */}
          {aktuel === 'import' && (
            <>
...
// Import-guiden — telefon-mockup af ReciDeals "+"-ark med en "Tryk her"-boble
      ...
      <Animated.View style={[styles.notifBanner, { transform: [{ translateY }], opacity }]}>
        ...
        <View style={{ flex: 1 }}>
          <View style={styles.notifTop}>
            <Text style={styles.notifApp}>ReciDeal</Text>
