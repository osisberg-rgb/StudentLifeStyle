...
**Goal:** Gør Mæt land-bevidst (DK/NO/SE) — hvert land får eget sprog, butikker, tilbudsaviser, valuta og opskrifter — med Danmark som det eneste land med rigtigt indhold. At tilføje NO/SE bagefter bliver rent indhold (dictionaries + tilbudsfiler + opskrifter), ingen kodeændringer.
